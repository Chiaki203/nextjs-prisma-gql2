...
export const TodoList:FC = () => {
  ...
  const handleSubmit:FormEventHandler<HTMLFormElement> = async(e) => {
    ...
    console.log('handleSubmit addTodoMutation data', data)
  ...
  const handleChange = async(todoId: string, completed: boolean):Promise<void> => {
    ...
    console.log('handleChange updateTodoMutation data', data)
  ...
  const handleDelete = async(todoId:string):Promise<void> => {
    ...
    console.log('handleDelete deleteTodoMutation data', data)
